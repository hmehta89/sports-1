...
Two metrics measure how much of the parent repo was captured:

```
File Coverage % = Extracted files        =  48  = 51.1%
                  ───────────────────────   ────
                  Total files in repo       94

LOC Coverage %  = Extracted lines of code =  914  = 37.6%
                  ─────────────────────────  ─────
                  Total lines in repo        2,429
```

| | Numerator (extracted) | Denominator (parent repo) | **Coverage** |
|---|---|---|---|
| **Files** | 48 | 94 | **51.1%** |
| **Lines of code** | 914 | 2,429 | **37.6%** |
